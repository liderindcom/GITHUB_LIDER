...
SCHEMA_FILES = [
    ...
    "product-commercial-scope.schema.json",
    "product-classification.schema.json",
    ...
    "operational-flow-projection.schema.json",
]
...
EXAMPLE_TO_SCHEMA = {
    ...
    "productClassifications": "product-classification.schema.json",
    "purchaseOrders": "purchase-order.schema.json",
